.. py:module:: PIL2.TiffTags
.. py:currentmodule:: PIL2.TiffTags
...
.. class:: TagInfo
  ...
  .. method:: __init__(self, value=None, name="unknown", type=None, length=0, enum=None)
     ...
     :param name: Tag Name
     :param type: Integer type from :py:attr:`PIL2.TiffTags.TYPES`
...
.. py:attribute:: PIL2.TiffTags.TAGS_V2

    The ``TAGS_V2`` dictionary maps 16-bit integer tag numbers to
    :py:class:`PIL2.TagTypes.TagInfo` tuples for metadata fields defined in the TIFF
    spec.

.. versionadded:: 3.0.0

.. py:attribute:: PIL2.TiffTags.TAGS

    The ``TAGS`` dictionary maps 16-bit integer TIFF tag number to
    descriptive string names.  For instance:

        >>> from PIL2.TiffTags import TAGS
        >>> TAGS[0x010e]
        'ImageDescription'
...
.. py:attribute:: PIL2.TiffTags.TYPES
