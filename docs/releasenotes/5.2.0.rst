...
Resolve confusion getting PIL2 / Pillow version string
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Re: "version constants deprecated" listed above, as user gnbl notes in #3082:

- it's confusing that PIL2.VERSION returns the version string of the former PIL2 instead of Pillow's
